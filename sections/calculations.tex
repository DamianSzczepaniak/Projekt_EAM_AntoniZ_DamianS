...
granicznych 1 Hz i 300 Hz oraz filtru Notcha wykorzystaliśmy wzory 
z książki "Op Amps for Everyone"\cite{SLOA088}. Zawarte są w niej 
wskazówki do projektowania flitrów, jak i obliczenia dla poszczególnych
topoligii.

    \subsection{Obliczenia dla filtra pasmowoprzepustowego}
...
\end{equation}
    ...
    \subsection{Obliczenia dla filtra Notcha o częstotliwości 50 Hz}
{\large\bfseries UZUPEŁNIĆ} 